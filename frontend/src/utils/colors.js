...
export const getSeverityClasses = (severity) => {
  ...
  return classes[severity?.toLowerCase()] || 'bg-gray-100 text-gray-800 border-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-700'
}
...
export const getImpactClasses = (impact) => {
  ...
  return classes[impact?.toLowerCase()] || 'bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300'
}
